 ...
 * 1 June 2015
 * 
 * The purpose of this program is to display time in different formats using
 * MyTime class. It also can check to see if the user created object
 * is the same as a predefined object, similar to an alarm.
 */
package Homework3;
